...
<body onresize="lengthdiv();">
	...
	<div class="container">
		<div class="row">
			<div id="d1" class="col-xs-12 col-sm-6 col-md-4">
				칼럼
			</div>
			<div id="d2" class="col-xs-12 col-sm-6 col-md-4">
				칼럼
			</div>
			<div id="d3" class="col-xs-12 col-sm-6 col-md-4">
				칼럼
			</div>
			
		</div>
	</div>
		<p id="window" align="center"></p>
</body>
</html>